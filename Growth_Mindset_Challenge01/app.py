...
# set up our app
st.set_page_config(page_title="🩸 Data sweepper", layout="wide")
st.title("💿 Data sweepper")
st.write("Transform your files between CVS and Excel formats with built_in data cleaning and visualization!")


uploaded_file = st.file_uploader("upload you files (csv or Execel):" , type=["csv","xlsx"],accept_multiple_files=True)
...
if uploaded_file:
    for file in uploaded_file:
        ...
        if file_ext == ".csv":
            ...
            st.error("Invalid file type: {file_ext}")
            continue
        ...
        # options for data cleaning and visualization
